...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm.js"}],"js/upload.js":[function(require,module,exports) {
"use strict";
...
(0, _upload.upload)('#file', {
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      var ref = storage.ref("imahes/".concat(file.name));
